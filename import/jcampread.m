...
% Based on: 
%   readreco.m
%   Function to read Bruker ParaVision RECO files to a structure
%
%   Written by B.C. Hamans, B.C.Hamans@student.tue.nl
%   v1.0 15-4-2003 Initial release
%
%   Ideas for future versions: Fix path for 2dseq function remove open file just pass file handle or dir handle etc etc etc
%
% Rewritten by:
